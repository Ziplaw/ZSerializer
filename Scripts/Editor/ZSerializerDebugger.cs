                            ...
                            if (ZSerialize.tempTuples[selectedGroupID] != null)
                            {
                                using (new GUILayout.HorizontalScope())
                                {
                                    using (new GUILayout.VerticalScope())
                                    {
                                        ...
                                        {
                                            if (GUILayout.Button(
                                                ZSerialize.tempTuples[selectedGroupID][i].Item1.Name
                                                    .Replace("ZSerializer", ""),
                                    ...
                                    GUILayout.Label(ZSerialize.tempTuples[selectedGroupID][selectedTypeIndex].Item2
                                        .Replace("{\"gameObjectInstanceID", "{\n\"gameObjectInstanceID"));
                                }
                            }
                        }
                    }
